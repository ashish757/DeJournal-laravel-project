...
<div class="flex">
    ...
    <main class="bg-gray-500 w-full">
        ...
        <form action="createPost/save" method="POST" enctype="multipart/form-data" id="createPostForm">
            @csrf
            <div class="m-4">
            ...
            <div class="m-4 border-2 bg-gray-100 focus:border-gray-400 focus:outline-none focus:bg-transparent rounded w-full flex">
                <ul class="flex gap-4 p-2" id="tagsUl">
                    <li class="px-4 py-1 grid place-content-center rounded-full bg-gray-400 border-2 border-gray-500 text-gray-50 font-semibold tracking-wide">india</li>
                    <li class="px-4 py-1 grid place-content-center rounded-full bg-gray-400 border-2 border-gray-500 text-gray-50 font-semibold tracking-wide">crime</li>
                </ul>
